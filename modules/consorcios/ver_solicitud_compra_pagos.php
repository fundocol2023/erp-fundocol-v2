...
<body class="consorcios-pagos-page">
        ...
        <div class="erp-card">
            ...
            <div class="solicitud-section">
                ...
                <div class="adjuntos-list">
                    <a class="btn-adjunto" href="<?= $cotizacion_base . urlencode($solicitud['cot_archivo']) ?>" target="_blank">
  ...
  <div class="mb-3">
    ...
    <input type="file" name="soporte_pago" id="soporte_pago" accept=".pdf,.jpg,.jpeg,.png">
  </div>

  <div class="mb-3">
    <label for="comentario_pagos" class="data-label">Comentario de pago (opcional):</label>
    <textarea name="comentario_pagos" id="comentario_pagos" rows="3" class="form-control" maxlength="300"
      placeholder="Escriba aquí el motivo de demora o información relevante (si aplica)"></textarea>
  </div>

  <div class="acciones-pagos solicitud-actions">
    <!-- Confirmar -->
    <button type="submit" name="accion" value="confirmar" class="btn-erp btn-erp-lg">
      <i class="bi bi-check-circle"></i> Confirmar Pago y Notificar
    </button>

    <!-- Rechazar -->
    <button type="submit" name="accion" value="rechazar" class="btn-erp-red btn-erp-lg">
